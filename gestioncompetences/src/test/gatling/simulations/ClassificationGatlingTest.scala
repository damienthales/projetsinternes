...
class ClassificationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Classification entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "classificationNom":"SAMPLE_TEXT", "classificationDateDebut":"2020-01-01T00:00:00.000Z", "classificationDateFin":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
