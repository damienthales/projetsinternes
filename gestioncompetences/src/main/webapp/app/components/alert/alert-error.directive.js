(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('gestioncompetencesApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-gestioncompetencesApp-error');
                var entityKey = httpResponse.headers('X-gestioncompetencesApp-params');
                if (errorHeader) {
